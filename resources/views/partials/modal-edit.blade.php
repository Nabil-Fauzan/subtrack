...
>
    ...
    >
        ...
        <!-- Modal Header -->
        <div class="flex items-center justify-between pb-5 border-b border-zinc-800/80 relative z-10">
            <div class="flex items-center space-x-3">
                ...
                <div>
                    <h3 class="text-lg font-bold text-white tracking-tight">Edit Langganan</h3>
                    <p class="text-xs text-zinc-400">Perbarui rincian data langganan yang dipilih</p>
                </div>
            </div>
            <button type="button" @click="editModalOpen = false" class="p-2 rounded-xl text-zinc-400 hover:text-white hover:bg-zinc-800/60 transition-colors cursor-pointer">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <form :action="'{{ url('/subscriptions') }}/' + editData.id" method="POST" class="mt-6 space-y-5">
            ...
            <!-- Service Name -->
            <div>
                <label for="edit_service_name" class="block text-xs font-semibold uppercase tracking-wider text-zinc-300 mb-1.5">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <!-- Category -->
                <div>
                    <label for="edit_category_id" class="block text-xs font-semibold uppercase tracking-wider text-zinc-300 mb-1.5">
                ...
                <!-- Payment Method -->
                <div>
                    <label for="edit_payment_method_id" class="block text-xs font-semibold uppercase tracking-wider text-zinc-300 mb-1.5">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <!-- Price (IDR) -->
                <div>
                    <label for="edit_price" class="block text-xs font-semibold uppercase tracking-wider text-zinc-300 mb-1.5">
                ...
                <!-- Billing Cycle -->
                <div>
                    <label for="edit_billing_cycle" class="block text-xs font-semibold uppercase tracking-wider text-zinc-300 mb-1.5">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 items-center">
                <!-- Next Billing Date -->
                <div>
                    <label for="edit_next_billing_date" class="block text-xs font-semibold uppercase tracking-wider text-zinc-300 mb-1.5">
                ...
                <div class="pt-4 sm:pt-6">
                    <label class="inline-flex items-center space-x-3 cursor-pointer">
                        ...
                        <div>
                            ...
                            <p class="text-[11px] text-zinc-400">Sertakan dalam perhitungan metrik</p>
                        </div>
                    </label>
                </div>
            </div>
